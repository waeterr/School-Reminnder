...
<body class="text-gray-900">
  ...
  <nav class="flex justify-between items-center px-6 py-4 shadow md:px-12 md:py-6">
    ...
    <ul class="hidden md:flex gap-10 font-semibold items-center">
      ...
      <li>
        <a href="{{ route('about-us') }}" class="px-6 py-2 bg-[#28477E] text-white font-semibold rounded-full">About
          Us</a>
      </li>
    </ul>
    ...
    <div class="hidden md:flex items-center gap-4">
      <a href="{{ route('signup') }}"
        class="border border-gray-800 px-5 py-2 rounded-full font-semibold hover:bg-gray-900 hover:text-white transition">
        Sign In
      </a>

      <a href="{{ route('login') }}"
        class="bg-gray-900 text-white px-5 py-2 rounded-full font-semibold hover:opacity-80 transition">
        Log In
      </a>
    </div>
    <!-- MOBILE BUTTON -->
  ...
  <div id="mobileMenu" class="hidden md:hidden bg-white shadow px-6 py-4">
    <ul class="flex flex-col gap-4 font-semibold">
      ...
      <li class="flex flex-col gap-3 mt-2">
        ...
        <a href="{{ route('signup') }}" class="border border-gray-800 px-4 py-2 rounded-lg text-center font-semibold">
          Sign In
        </a>
      </li>
    </ul>
