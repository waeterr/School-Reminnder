    ...
    <div id="main" class="hidden">
        ...
        <section class="px-10 mt-20 flex flex-col md:flex-row items-center justify-between">
            ...
            <div class="mt-10 md:mt-0 md:ml-10">
                ...
                <div class="w-[330px] h-[330px] bg-gray-200 rounded-lg"></div>
        ...
        <footer class="bg-[#E4E4E4] py-10 text-center">
            ...
            <div class="flex justify-center gap-4 mt-6">
                <img src="mail.png" class="w-6">
                <img src="instagram.png" class="w-6">
                <img src="facebook.png" class="w-6">
            </div>
